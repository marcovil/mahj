...
public class MySortAnonymousClasses {
 ...
 /*   *//*
    ...
    *//**
     ...
     *//*
    public static void main (String[] a){ int[] arr1 = {10,34,2,56,7,67,88,42};
        doParametricSort(arr1, SortDirection.INCREASING); System.out.format("Increasing: ");
        for(int i:arr1){
            System.out.print(i);
            System.out.print(", ");
        }
        doParametricSort(arr1, SortDirection.DECREASING); System.out.format("\nDecreasing: ");
        for(int i:arr1){
            System.out.print(i);
            System.out.print(", ");
        }
 ...
 * *//*
    private static void doParametricSort(int[] a, SortDirection dir) {
        ...
        switch (dir) {
            ...
            doInsertionSort(a, ic);
                ...
                *//**
                 * Sort the array a using the direction implied by the * generic comparator. MODIFY array a.
                 * @param a
    ...
    *//**
    ...
    private static void swap(int[] a, int j) { int temp;
        temp = a[j];
        a[j] = a[j-1];
        a[j-1] = temp;
    } }*/
